...
import old.silly_goose.registry.SillyGooseItemTags;

import java.util.concurrent.CompletableFuture;

public class SillyGooseItemTagProvider extends FabricTagProvider.ItemTagProvider {
    public SillyGooseItemTagProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> completableFuture) {
