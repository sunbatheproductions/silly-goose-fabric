package old.silly_goose.entity.egg;
...
public class SmallGooseEggEntity extends ThrowableItemProjectile {
    private static final EntityDimensions EMPTY_DIMENSIONS = EntityDimensions.fixed(0.0F, 0.0F);

    public SmallGooseEggEntity(EntityType<? extends SmallGooseEggEntity> entityType, Level world) {
        super(entityType, world);
    }

    public SmallGooseEggEntity(Level world, LivingEntity owner, ItemStack stack) {
        super(SillyGooseEntities.SMALL_WHITE_EGG, owner, world, stack);
    }

    public SmallGooseEggEntity(Level world, double x, double y, double z, ItemStack stack) {
