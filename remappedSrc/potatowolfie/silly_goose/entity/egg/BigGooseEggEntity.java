...
public class BigGooseEggEntity extends ThrowableItemProjectile {
    private static final EntityDimensions EMPTY_DIMENSIONS = EntityDimensions.fixed(0.0F, 0.0F);

    public BigGooseEggEntity(EntityType<? extends BigGooseEggEntity> entityType, Level world) {
        super(entityType, world);
    }

    public BigGooseEggEntity(Level world, LivingEntity owner, ItemStack stack) {
        super(SillyGooseEntities.BIG_WHITE_EGG, owner, world, stack);
    }

    public BigGooseEggEntity(Level world, double x, double y, double z, ItemStack stack) {
